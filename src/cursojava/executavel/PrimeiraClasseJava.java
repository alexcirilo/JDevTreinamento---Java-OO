	...
	public static void main(String[] args) {
		...
		try {
			...
			if (new FuncaoAutenticacao(
				new Diretor(login, senha)).autenticar()) { /*
				...
				for (int qte = 1; qte <= 1; qte++) {
					...
					aluno1.setIdade(Integer.valueOf(JOptionPane
			...
			for (int pos = 0; pos < e
				.getStackTrace().length; pos++) {
				saida.append("\nClasse de erro: "
					+ e.getStackTrace()[pos].getClassName());
				saida.append("\nMétodo de erro: "
					+ e.getStackTrace()[pos].getMethodName());
				saida.append("\nLinha de erro: "
